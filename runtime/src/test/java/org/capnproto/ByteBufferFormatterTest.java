...
public class ByteBufferFormatterTest {
    ...
    public void testDefaultBig() {
        ...
        assertThat(format, is("44 bytes 54 65 78 74 20 20 20 20 20 20 ...20 73 69 70 |Text..........sip"));
    }
    ...
    public void testSizeHexBig() {
        ...
        assertThat(format, is("44 bytes 54 65 78 74 20 20 20 20 20 20 ...20 73 69 70 "));
    }
    ...
    public void testHexBig() {
        ...
        assertThat(format, is("54 65 78 74 20 20 20 20 20 20 ...20 73 69 70 "));
    }

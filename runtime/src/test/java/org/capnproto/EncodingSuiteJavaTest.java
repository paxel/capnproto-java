...
public class EncodingSuiteJavaTest {
    ...
    public void testSerializedSize() {
        ...
        final TestAnyPointer.Builder root = builder.initRoot(TestAnyPointer.FACTORY.get());
    ...
    public void testAllTypesMultiSegment() {
        ...
        TestAllTypes.Builder allTypes = message.initRoot(TestAllTypes.FACTORY.get());
